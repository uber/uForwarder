...
@TestPropertySource(properties = {"spring.config.location=classpath:/rpccolocatingrebalancer.yaml"})
@ActiveProfiles({"data-transfer-controller", "uforwarder-controller"})
public class UForwarderControllerFactoryRpcColocatingRebalancerTest extends FievelTestBase {
  ...
  public void testRebalancer() {
    ...
    Assert.assertTrue(this.rebalancer instanceof RpcJobColocatingRebalancer);
  }
