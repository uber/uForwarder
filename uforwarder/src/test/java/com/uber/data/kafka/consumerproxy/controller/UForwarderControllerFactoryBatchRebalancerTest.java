...
@TestPropertySource(properties = {"spring.config.location=classpath:/batchrebalancer.yaml"})
@ActiveProfiles({"data-transfer-controller", "uforwarder-controller"})
public class UForwarderControllerFactoryBatchRebalancerTest extends FievelTestBase {
  ...
  public void testRebalancer() {
    ...
    Assert.assertTrue(this.rebalancer instanceof BatchRpcUriRebalancer);
  }
